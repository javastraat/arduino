...
#define LED_PIN 3           // first LED output
#define POWER_PIN 5        // second LED output, corresponds to power button
...
{  
  switch (key)
  {
    case 33526381:  // record button
      Serial.println("toggle debug pulse");
      runtime_debug = 1 - runtime_debug;
      break;
    case 33518221:  // display button
      Serial.println("Toggle key output");
      output_key = 1 - output_key;
      break;
    case 33489661:  // power button
      Serial.println("Power");
      power_button = 1 - power_button;
      set_power();
      break;
    case 33508021:  // channel up button
      Serial.println("Channel Up");
      break;      
    case 33516181:  // channel down button
      Serial.println("Channel Down");
      break;
    case 33530461:  // up rocker/pause
      power_level+=1;
      set_power();
      break;
    case 33534541:  // down rocker/stop
      power_level-=1;
      set_power();
      break;      
    case 33510061:  // left rocker/rewind
      if (power_level < 50)
      {
        power_level-=3;
      }
      ...
      set_power();
      break;
    case 33493741:  // right rocker/fast forward
      if (power_level < 50)
      {
        power_level+=3;
      }
