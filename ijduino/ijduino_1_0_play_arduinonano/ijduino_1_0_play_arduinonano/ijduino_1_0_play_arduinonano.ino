...
bool skip;
skip = render(drip1, 200);
if (skip) {
  return;
}
skip = render(drip2, 200);
if (skip) {
  return;
}
skip = render(drip3, 200);
if (skip) {
  return;
}
skip = render(drip4, 200);
if (skip) {
  return;
}
skip = render(drip5, 200);
if (skip) {
  return;
}
skip = render(drip6, 200);
if (skip) {
  return;
}
skip = render(drip7, 200);
if (skip) {
  return;
}
skip = render(drip8, 200);
if (skip) {
  return;
}
skip = render(drip9, 200);
if (skip) {
  return;
}
skip = render(drip10, 200);
if (skip) {
  return;
}
render(drip11, 200);
