...
// In this case a user defined bitmap is created and animated.
{
  ...
  { 
0B00000000, // This is the first frame for alien #1
0B00000000, // If you squint you can kind of see the
0B00000000, // image in the 0's and 1's.
0B11111111,
0B11111111,
0B00000000,
0B00000000,
...
// Display text and animate scrolling using auto wraparound of the buffer
{
  ...
  {
    mx.setChar(((j+1)*COL_SIZE)-1, (j&1 ? 'A' : 'E'));
  }
  delay(DELAYTIME*5);
