...
static const int PADDLE0_PIN = A0;
static const int PADDLE1_PIN = A5;
...
class LedMatrixPong : public Pong
{
  public:
    ...
    void showPaddle(Paddle& p) {
      setPaddle(p, true);
    }
    void hidePaddle(Paddle& p) {
      setPaddle(p, false);
    }

    void showBall(Ball& b) {
      ledControl_.setLed(0, b.col(), b.row(), true);
    }
    void hideBall(Ball& b) {
      ledControl_.setLed(0, b.col(), b.row(), false);
    }
