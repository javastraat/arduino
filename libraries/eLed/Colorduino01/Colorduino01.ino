...
void loop()
{
  DrawLine(2,12,128,228);
  DrawLine(4,34,12,128);
  DrawLine(6,134,135,8);
  DrawColumn(0,132,128,228) ;
  DrawColumn(2,12,128,228) ;
  DrawColumn(4,34,12,128) ;
  DrawColumn(6,134,135,8) ;
  delay(1000);
}
