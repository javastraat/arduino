...
---------------------------------------------*/
static PROGMEM prog_uchar bomb_blast[] = {
  0x08, 0x22, 0x0d, 0x1e, 0x2e, 0x1f, 0x2e, 0x15
};
static PROGMEM prog_uchar bullet_blast[] = {
...
public:
  ...
  void reset(byte gr, prog_char *ct) {
    initialize();
    graphic = gr;
    columnTable = ct;
    if (!tablePtr) {
