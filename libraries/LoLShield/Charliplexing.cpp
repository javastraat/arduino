...
const LEDPosition PROGMEM ledMap[126] = {
    L(5,13), L(6,13), L(7,13), L(8,13), L(9,13), L(10,13), L(11,13), L(12,13), L(4,13), L(13,4), L(3,13), L(13,3), L(2,13), L(13, 2),
    L(5,12), L(6,12), L(7,12), L(8,12), L(9,12), L(10,12), L(11,12), L(13,12), L(4,12), L(12,4), L(3,12), L(12,3), L(2,12), L(12, 2),
    L(5,11), L(6,11), L(7,11), L(8,11), L(9,11), L(10,11), L(12,11), L(13,11), L(4,11), L(11,4), L(3,11), L(11,3), L(2,11), L(11, 2), 
    L(5,10), L(6,10), L(7,10), L(8,10), L(9,10), L(11,10), L(12,10), L(13,10), L(4,10), L(10,4), L(3,10), L(10,3), L(2,10), L(10, 2),
    L(5,9),   L(6,9),   L(7,9),   L(8,9),   L(10,9), L(11,9),   L(12,9),   L(13,9),   L(4,9),   L(9,4),   L(3,9),   L(9,3),   L(2,9),   L( 9, 2),  
    L(5,8),   L(6,8),   L(7,8),   L(9,8),   L(10,8), L(11,8),   L(12,8),   L(13,8),   L(4,8),   L(8,4),   L(3,8),   L(8,3),   L(2,8),   L( 8, 2), 
    L(5,7),   L(6,7),   L(8,7),   L(9,7),   L(10,7), L(11,7),   L(12,7),   L(13,7),   L(4,7),   L(7,4),   L(3,7),   L(7,3),   L(2,7),   L( 7, 2), 
    L(5,6),   L(7,6),   L(8,6),   L(9,6),   L(10,6), L(11,6),   L(12,6),   L(13,6),   L(4,6),   L(6,4),   L(3,6),   L(6,3),   L(2,6),   L( 6, 2), 
    L(6,5),   L(7,5),   L(8,5),   L(9,5),   L(10,5), L(11,5),   L(12,5),   L(13,5),   L(4,5),   L(5,4),   L(3,5),   L(5,3),   L(2,5),   L( 5, 2), 
};
#undef P(pin)
#undef L(high, low)
