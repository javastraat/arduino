    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<br />");
          client.print("<INPUT type=\"radio\" name=\"color\" value=\"rainbow\">Rainbow slow");
          client.println("<br />");
          client.print("<INPUT type=\"radio\" name=\"color\" value=\"rainwave\">Rainbow fast");
...
if(buffer.indexOf("GET /?color=rainbow")>=0)
            rainbowCycle(20); 
if(buffer.indexOf("GET /?color=rainwave")>=0)
            rainbowCycle(2); 
if(buffer.indexOf("GET /?color=knightrider")>=0)
knightRider();
if(buffer.indexOf("GET /?color=kit")>=0)
