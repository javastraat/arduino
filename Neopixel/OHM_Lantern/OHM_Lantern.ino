    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<H1>OHM Lantern Controlpage</H1><br />");
          client.print("<FORM action=\"/\" >");
          client.print("<INPUT type=\"radio\" name=\"color\" value=\"OFF\">OFF<br />");
          client.print("<INPUT type=\"radio\" name=\"color\" value=\"white\">White<br />");
          client.print("<INPUT type=\"radio\" name=\"color\" value=\"polizei\">Polizei<br />");
